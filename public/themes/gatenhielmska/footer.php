<div class="footer">
    <div class="footer_parts">
        ...
        <ul class="footer_list">
            <li class="footer_list_item"><a href="">Hitta hit</a></li>
            <li class="footer_list_item"><a href="">Öppettider</a></li>
            <li class="footer_list_item"><a href="">Kontakt</a></li>
            <li class="footer_list_item"><a href="">Biljetter</a></li>
